...
export default function ProjectDetail() {
  ...
  const {
    ...
    queryFn: () =>
      apiClient.get<{ data: Project }>(`/projects/${id}`).then((r) => r.data),
    enabled: !!id,
  });
    ...
    >
      <div className="w-full max-w-2xl">
        ...
        <Motion.div {...FADE(0.1)}>
          ...
          <h2
            className="text-[18px] text-white mb-4"
        ...
        {scansLoading ? (
          ...
          >
            ...
            <p
              ...
              style={{ color: 'rgba(255,255,255,0.35)', fontFamily: "'Inter', sans-serif" }}
            >
              Submit a scan via the API to see results here.
            </p>
          </Motion.div>
        ) : (
                ...
                <div className="grid grid-cols-3 divide-x" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
                  <div className="px-5 py-4">
                    <div className="flex items-center gap-1.5 mb-1">
                      <FolderKanban className="w-3 h-3" style={{ color: 'rgba(255,255,255,0.3)' }} />
                      <p
                    ...
                    <p className="text-[15px] text-white" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>
                      {scan.summary?.totalEndpoints ?? '—'}
                    </p>
                  </div>
                  <div className="px-5 py-4">
                    <div className="flex items-center gap-1.5 mb-1">
                      <DollarSign className="w-3 h-3" style={{ color: 'rgba(255,255,255,0.3)' }} />
                      <p
                        className="text-[10px] uppercase tracking-[0.1em]"
                        style={{ color: 'rgba(255,255,255,0.22)', fontFamily: "'JetBrains Mono', monospace" }}
                      >
                    ...
                    <p className="text-[15px] text-white" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>
                      {scan.summary?.totalMonthlyCost != null ? fmtCost(scan.summary.totalMonthlyCost) : '—'}
                    </p>
                  </div>
                  <div className="px-5 py-4">
                    <div className="flex items-center gap-1.5 mb-1">
