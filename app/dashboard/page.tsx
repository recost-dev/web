...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Point the Recost scanner at your source files. It extracts outbound HTTP calls, submits them to the API, and surfaces cost estimates and optimization suggestions.',
    action: '/docs',
    cta: 'View API Docs',
    features: [
      ...
      <div className="pb-24 space-y-5 px-5 md:px-10" style={{ maxWidth: 'calc(100% * 6 / 7)', margin: '0 auto' }}>
        ...
        <Motion.div {...FADE(0)} className="px-4 pb-6">
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '16px', color: 'rgba(255,255,255,0.45)', lineHeight: 1.7 }}>
            Recost tracks exactly what your APIs cost. Here&apos;s how to get up and running in a few minutes.
          </p>
        </Motion.div>
          ...
          <SectionCard key={badge} icon={icon} badge={badge} title={title} subtitle={subtitle} delay={0.05 + i * 0.07}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
              {features.map(({ icon: FIcon, label, desc }) => (
                ...
                >
                  <div className="mt-0.5 p-1.5 rounded-lg shrink-0" style={{ background: `${accent}18` }}>
