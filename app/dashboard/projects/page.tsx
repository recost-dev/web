      ...
      <div className="w-full max-w-2xl">
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-[10px] uppercase tracking-[0.15em]" style={{ fontFamily: "'JetBrains Mono', monospace", color: accent }}>
                  Projects
                </span>
              </div>
              <h1 className="text-[32px] text-white" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, lineHeight: 1.1 }}>
                Your Projects
              </h1>
              <p className="mt-1 text-[13px]" style={{ color: 'rgba(255,255,255,0.38)', fontFamily: "'JetBrains Mono', monospace" }}>
            ...
            <button
              ...
              style={{
                ...
                background: atLimit ? 'rgba(255,255,255,0.04)' : `${accent}18`,
                border: `1px solid ${atLimit ? 'rgba(255,255,255,0.08)' : accent + '44'}`,
                color: atLimit ? 'rgba(255,255,255,0.2)' : accent,
              }}
            >
        ...
        {isLoading ? (
          ...
          >
            ...
            <p className="text-[14px] text-white mb-1" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>Failed to load projects</p>
          ...
          >
            ...
            <p className="text-[15px] text-white mb-1" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>No projects yet</p>
            <p className="text-[13px]" style={{ color: 'rgba(255,255,255,0.35)', fontFamily: "'Inter', sans-serif" }}>
          ...
          <div className="space-y-3">
            {projects.map((p, i) => (
              ...
              >
                <div className="p-2.5 rounded-xl flex-shrink-0" style={{ background: `${accent}14`, border: `1px solid ${accent}28` }}>
                  <FolderKanban className="w-4 h-4" style={{ color: accent }} />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[14px] text-white font-semibold truncate" style={{ fontFamily: "'Inter', sans-serif" }}>{p.name}</p>
                  <div className="flex items-center gap-3 mt-0.5 flex-wrap">
                    {p.latestScanId ? (
                      <>
                        <span className="flex items-center gap-1 text-[11px]" style={{ color: 'rgba(255,255,255,0.28)', fontFamily: "'JetBrains Mono', monospace" }}>
                      ...
                      <span className="text-[11px] px-2 py-0.5 rounded-md" style={{ fontFamily: "'JetBrains Mono', monospace", color: 'rgba(255,255,255,0.3)', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <div className="flex items-center gap-4 flex-shrink-0">
                  <span className="text-[11px]" style={{ color: 'rgba(255,255,255,0.2)', fontFamily: "'JetBrains Mono', monospace" }}>{fmt(p.createdAt)}</span>
                  <button
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <div>
                  <p className="text-[10px] uppercase tracking-[0.15em] mb-1" style={{ fontFamily: "'JetBrains Mono', monospace", color: accent }}>New</p>
                  <h2 className="text-[16px] text-white" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>Create Project</h2>
                </div>
                <button
                  onClick={() => setShowCreate(false)}
                  className="p-1.5 rounded-lg transition-all cursor-pointer hover:bg-white/5 hover:text-white/70"
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                <div>
                  <label className="block text-[11px] uppercase tracking-[0.1em] mb-2" style={{ fontFamily: "'JetBrains Mono', monospace", color: 'rgba(255,255,255,0.35)' }}>
                    Project name
                  </label>
                  <input
                    autoFocus
                  ...
                  />
                  {createError && <p className="text-[12px] mt-2" style={{ color: '#f87171', fontFamily: "'Inter', sans-serif" }}>{createError}</p>}
                </div>
          ...
          >
            ...
            >
              <div className="flex items-start gap-3 mb-5">
                <div className="p-2 rounded-xl flex-shrink-0 mt-0.5" style={{ background: 'rgba(248,113,113,0.1)', border: '1px solid rgba(248,113,113,0.2)' }}>
                  <Trash2 className="w-4 h-4" style={{ color: '#f87171' }} />
                </div>
                <div>
                  <h2 className="text-[15px] text-white mb-1" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>Delete project?</h2>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  style={{ fontFamily: "'Inter', sans-serif", background: 'rgba(248,113,113,0.1)', border: '1px solid rgba(248,113,113,0.25)', color: '#f87171' }}
                >
