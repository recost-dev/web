...
export const MOCK_ENDPOINTS = [
  {
    ...
    callSites: [
      ...
      { file: 'src/workers/review-worker.ts', line: 17, library: 'openai', frequencyClass: 'parallel',
        crossFileOrigin: { file: 'src/services/ai.ts', functionName: 'generateReview' } },
    ],
    callsPerDay: 1200,
    monthlyCost: 98.50,
    ...
    costModel: { model: 'per_token', perCallCost: 0.002 },
    streaming: true,
  ...
  },
  {
    ...
    costModel: { model: 'per_token', perCallCost: 0.006 },
    streaming: true,
  },
  {
    id: 'ep_003',
    ...
    costModel: { model: 'per_token', perCallCost: 0.0001 },
    batchCapable: true,
